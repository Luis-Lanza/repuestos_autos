...
export function SaleScreen(props: { onInventoryAlertsRefresh?: () => void } = {}) {
  ...
  const cartItems = state.lines.map((line, index) => createElement("tr", { key: line.product_id },
    createElement("td", { "data-label": "Producto / SKU" },
      createElement("strong", null, line.product_name), createElement("span", { "data-ui-sku": true }, line.sku)),
    createElement("td", { "data-label": "Lista / mínimo" },
    ...
    createElement("td", { "data-label": "Cantidad" },
    ...
    createElement("td", { "data-label": "Precio final" },
  ...
  const checkoutContent = createElement("div", { "data-ui-checkout-content": true },
    createElement("section", { "aria-labelledby": "checkout-cart-heading" },
      ...
      createElement("table", { "aria-label": "Carrito", "data-ui-sale-cart": true, "data-ui-aligned-data": true },
        createElement("thead", null, createElement("tr", null,
          createElement("th", { scope: "col" }, "Producto / SKU"),
          createElement("th", { scope: "col" }, "Lista / mínimo"),
          createElement("th", { scope: "col" }, "Cantidad"),
          createElement("th", { scope: "col" }, "Precio final"),
          createElement("th", { scope: "col" }, "Subtotal"),
          createElement("th", { scope: "col" }, "Acciones"))),
        createElement("tbody", null, cartItems))),
