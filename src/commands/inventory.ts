...
export interface PersistedInventoryOperation { request_id: string; product_id: number; previous_quantity: number; quantity_delta: number; resulting_quantity: number; occurred_at: string; }
