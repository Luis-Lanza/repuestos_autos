...
The project skill set is vendored for consistent behavior across supported agent clients. `skills-lock.json` records each upstream repository, skill path, and content hash. The license texts in this directory were retrieved from the corresponding official upstream repositories.
